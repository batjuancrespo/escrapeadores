...
# URL base
url_base = 'https://competicionesfecan.optimalwayconsulting.com/competicion/1449'
...
while jornada_actual > 0:
    ...
    if conteo_prepartido > 3:
        ...
        for i, resultado in enumerate(resultados, start=11):
            sheet.update_cell(i, 1, f"Club (BEN): {resultado}")  # Columna 1
