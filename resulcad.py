...
# URL base
url_base = 'https://competicionesfecan.optimalwayconsulting.com/competicion/1427'
...
while jornada_actual > 0:
    ...
    if conteo_prepartido > 3:
        ...
        for i, resultado in enumerate(resultados, start=8):
            sheet.update_cell(i, 2, f"Club (CAD): {resultado}")  # Columna 2
