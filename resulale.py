...
# URL base
url_base = 'https://competicionesfecan.optimalwayconsulting.com/competicion/1431'
...
while jornada_actual > 0:
    ...
    if conteo_prepartido > 3:
        ...
        for i, resultado in enumerate(resultados, start=10):
            sheet.update_cell(i, 2, f"Club (ALE): {resultado}")  # Columna 1
